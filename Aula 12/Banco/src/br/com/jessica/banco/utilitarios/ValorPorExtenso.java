package br.com.jessica.banco.utilitarios;
...
//		return "" + saldo;
	    ...
	    public ValorPorExtenso(float dec) throws NumberFormatException {
	        this();
	        setNumber(dec);
	    }
	    
	    public ValorPorExtenso(double dec) throws NumberFormatException {
	        this();
	        setNumber(dec);
	    }

	    public void setNumber(BigDecimal dec) throws NumberFormatException {
	        valorMonetario = dec;
	    ...
	    public void setNumber(double dec) throws NumberFormatException {
